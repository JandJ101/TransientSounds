...
nav.nav = '<a class="navbar-brand" href="/">'+
...
'            </li>'+
'            <li class="nav-item" id="premiumLink">'+
'              <a class="nav-link" href="#">PREMIUM PACKS</a>'+
'            </li>'+
...
nav.footer = '<div class="row" id="socialLinks">'+
'            <a class="col" href="https://gumroad.com/transientsounds/" target="_blank">'+
'                <img src="img/social/gumroad.png" alt="Gumroad">'+
'            </a>'+
'            <a class="col" href="https://www.instagram.com/transient_sounds/" target="_blank">'+
'                <img src="img/social/instagram.png" alt="Instagram">'+
'            </a>'+
'            <a class="col" href="https://soundcloud.com/transientsounds321/" target="_blank">'+
'                <img src="img/social/soundcloud.png" alt="SoundCloud">'+
'            </a>'+
'            <a class="col" href="https://www.youtube.com/channel/UCST-0wwXbYwRKO0Yd9M37Hg" target="_blank">'+
'                <img src="img/social/youtube.png" alt="YouTube">'+
'            </a>'+
'            '+
'          </div>'+
'          <div class="bg-primary bg-darker align-items-center">'+
'              <p class="text-center py-3 text-white m-0">© 2020 Copyright: Transient Sound</p>'+
'          </div>';
